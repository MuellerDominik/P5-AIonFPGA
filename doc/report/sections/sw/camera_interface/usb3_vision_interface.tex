...
\todo[inline]{Citations, Table position, Text that leader is ignored!}
...
% Other information besides the actual image data, so-called metadata, is also transmitted
% by default. This information is located in the leader and could for instance be:
