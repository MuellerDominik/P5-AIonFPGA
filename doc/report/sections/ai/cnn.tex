...
% For this reason, CNNs use special layers to reduce the amount of data.
For this reason, convolutional neural networks use special layers to detect features and reduce the amount of data.
% Convolutional neural networks work with three different types of layers.
The three different layers used are convolution layers, pooling layers and fully-connected layers.
% Convolutional neural networks work with convolution layers, pooling layers and fully-connected layers.
...
% The different kernels are able to detect certain features in the image.
...
% Pooling is done by looking only at the portion of the image covered by the kernel.
...
% There are two types of pooling, maximum and average pooling.
% This is usually done by looking at the portion of the image covered by the kernel 
By doing so, the required computational power is significantly decreases and the dominat features are extracted.
% Furthermore, dominat features are extracted by using.
% https://towardsdatascience.com/a-comprehensive-guide-to-convolutional-neural-networks-the-eli5-way-3bd2b1164a53
\\

\paragraph{Fully-Connected Layer}
% The fully-connected layers use the result of the convolution process to determine the appropriate label.
...
% Each value represents a probability that a certain feature belongs to a certain label.
Each value corresponds to a probability that a certain feature belongs to a certain label.
% They are responsible for learning the non-linear combinations of the high-level convolved features.
% The output of the convolution process is flattend into a vector.
% The result of the convolution process is flattened into a vector of probabilities, each representing a certain feature.
% https://towardsdatascience.com/a-comprehensive-guide-to-convolutional-neural-networks-the-eli5-way-3bd2b1164a53
